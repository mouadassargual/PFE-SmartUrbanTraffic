...
\textbf{0,792 mAP50} et \textbf{0,579 mAP50-95}
sur le split test.

La politique MDP a été validée sur cinq scénarios
représentatifs couvrant trafic dense Nord-Sud,
trafic Est-Ouest, urgence, piétons et absence de
trafic. Dans chaque cas, la phase produite correspond
à la phase attendue.
Les cinq hypothèses de recherche sont confirmées,
...
The final \textbf{YOLO26n Step 3 960} model reaches
\textbf{0.792 mAP50} and \textbf{0.579 mAP50-95}
on the test split.

The MDP policy was validated on five representative
scenarios covering dense North-South traffic,
East-West traffic, emergency priority, pedestrian
priority, and no-traffic conditions. In every case,
the produced phase matches the expected phase.
All five research hypotheses are confirmed, demonstrating
...
كما حقق النموذج النهائي
\LR{YOLO26n Step 3 960}
\textbf{\LR{0.792 mAP50}}
على مجموعة الاختبار.

تم التحقق من سياسة \LR{MDP}
عبر خمسة سيناريوهات ممثلة تشمل
ازدحام محور الشمال-الجنوب،
وحركة الشرق-الغرب، والأولوية لحالة
الطوارئ، وأولوية المشاة، وحالة عدم
وجود حركة مرور. في كل حالة كانت
المرحلة المنتجة مطابقة للمرحلة المتوقعة.
تم التحقق من الفرضيات الخمس للبحث،
